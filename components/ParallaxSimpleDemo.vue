...
<template>
  <div class="parallax-simple-demo fill-height">
    <div class="content-item">內容1</div>
    ...
    <div class="content-item">內容4</div>
    <div class="foot">foot</div>
  </div>
</template>

<style lang="scss">
.parallax-simple-demo {
  .content-item {
